      ...
      <div className="-mr-10">
        ...
        <div className=" ml-16 mt-4 ">
          ...
          <div className="flex w-[650px]">
            <div>
              <img
                className="h-8 border border-gray-200 rounded-full mt-2 items-center"
            ...
            <div className="mr-4 ">
              <div className="ml-2 ">
                ...
                <div className="mr-1 font-roboto text-[12px] leading-[1.8rem] font-normal overflow-hidden">
                  1.84M subscriber
                </div>
              </div>
            </div>
            <div className="items-center mt-1">
              <button className="bg-black text-white text-sm font-bold rounded-full hover:bg-slate-700 py-2 px-3 ">
                Subscribe
              </button>
            </div>
            <div className="w-full items-center bg-white  border-t-gray-300 ">
              <Button name="Share" />
            </div>
          </div>
        </div>
